      ...
      <div className="container">
        <article className="project">
          <h2 className="display">
            ...
            <a
              href="https://github.com/LeeWannacott/tweet-repair-game-django"
              target="_blank"
            >
              <button className="btn btn-outline-info">
                View GitHub Page.
        ...
        <article className="project">
          <h2 className="display">
            ...
            <hr></hr>
            <a
              href="https://leewannacott.github.io/Portfolio/#/GitHub"
              target="_blank"
            >
              <button className="btn btn-outline-info">
                View live example.
            ...
            <a
              href="https://github.com/LeeWannacott/table-sort-js"
              target="_blank"
            >
              <button className="btn btn-outline-info">
                View GitHub page.
            ...
            <a
              href="https://leewannacott.github.io/table-sort-js/table-sort.js"
              target="_blank"
            >
              <button className="btn btn-outline-info">
                View source code.
        ...
        <article className="project">
          <h2 className="display">
            ...
            <hr></hr>
            <a
              href="https://github.com/LeeWannacott/image-selector-opencv-python/blob/master/image_selector_from_video.py"
              target="_blank"
            >
              <button className="btn btn-outline-info">
                View Source Code.
            ...
            <a
              href="https://github.com/LeeWannacott/image-selector-opencv-python"
              target="_blank"
            >
              <button className="btn btn-outline-info">
                View Github Page.
        ...
        <article className="project">
          <h2 className="display">
            ...
            <hr></hr>
            <a
              href="https://github.com/LeeWannacott/MYS-Mark-Your-Spreadsheet"
              target="_blank"
            >
              <button className="btn btn-outline-info">
                View GitHub Page.
        ...
        <article className="project">
          <h2 className="display">
            ...
            <hr></hr>
            <a
              href="https://github.com/LeeWannacott/nvim-dogecomments"
              target="_blank"
            >
              <button className="btn btn-outline-info">
                View GitHub Page.
